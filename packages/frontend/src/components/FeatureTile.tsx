...
const FeatureTile: React.FC<FeatureTileProps> = ({ icon, title, description }) => (
  <div className="cursor-pointer p-6 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 border border-perfectify-light/30 group transition-all duration-300 relative overflow-hidden">
