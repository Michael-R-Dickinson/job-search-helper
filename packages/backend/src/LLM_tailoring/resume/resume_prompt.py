...
Each question should be answerable simply with a Yes or No and correspond to a specific intended change to a paragraph. You must have between 3-6 questions. Do not ask obvious questions or interest based questions where if the answer was No the user would not be applying. 
